...
function Login (){
    ...
    async function onLogin(event){
        ...
        // Here we can handle the form submission logic, such as sending the loginData to your backend API
        ...
        // Directly dispatching login action with loginData not need to create FormData since we are not uploading files
